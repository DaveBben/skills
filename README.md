...
|---|---|---|
| [SDLC](plugins/SDLC/) | Take an engineering change from a vague ask to a verified production change: define the outcome and its acceptance criteria, slice it, write failing tests first, build, review in three passes, ship and log. Twelve skills. | live |
...
# install one skill (execute invokes feature, story, next-story, test-table, review, merge-request, spike, adr and orient by name; install those with it)
