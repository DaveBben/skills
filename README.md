...
|---|---|---|
| [SDLC](plugins/SDLC/) | Take an engineering change from a vague ask to a verified production change: price it, discover the real problem, spec it, design it, write failing tests first, build slice by slice, ship behind a flag, verify it live, clean up. Three skills. | live |
