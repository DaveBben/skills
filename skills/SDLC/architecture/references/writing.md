...
* **A question is a question.** "Do you want me to set up the checks first? The CI workflow runs two checks the local command skips, so a story can pass here and fail there." Then stop. Never script the user's reply.
